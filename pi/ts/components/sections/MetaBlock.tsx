      ...
      <div className='sdpi-item'>
        <details className='message info'>
          <summary className='sdpi-item-value'>
            ...
            <div className='sdpi-item-child' style={{ marginTop: -6 }}>
              <a onClick={() => state.sdClient.openUrl({ url: 'discord.gg/YWy3UAy' })}>Discord</a>
              <a onClick={() => state.sdClient.openUrl({ url: 'github.com/tobimori/streamdeck-toggl' })}>GitHub</a>
              <a onClick={() => state.sdClient.openUrl({ url: 'ko-fi.com/tobimori' })}>Ko-fi</a>
            </div>
          </summary>
        </details>
      </div>
